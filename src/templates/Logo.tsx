Since the task requires changing the color palette, we need to update the `fill-primary-700` class in the `Logo.tsx` file. We will replace it with `fill-brown-700` to match the new brown color palette.

Here's the updated `Logo.tsx` file:
  ...
  return (
    <span className={`text-gray-900 inline-flex items-center ${fontStyle}`}>
      <svg
        ...
        className="w-6 h-6 mr-2 fill-brown-700" // Updated the fill color class
      >
        <path
